const preguntas = ["¿Cuál es el país de la playa y del Carnaval?","¿Cuál es el país del sol, flamenco y paella?","¿Cuál es el país del salmón y la nieve?","¿Cuál es el país de Atacama y la Isla de Pascua?","¿Cuál es el país del hockey y los alces?"];
const respuestas = ["brasil","españa","suecia","chile","canada"];
